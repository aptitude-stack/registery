...
Use this directory for working analysis that is intentionally not canonical.

## Rules

- Treat every file here as context, not current truth.
- Each draft should link back to the live canonical docs it depends on.
- Promote, merge, or delete drafts once the idea settles.
